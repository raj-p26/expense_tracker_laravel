<div class="modal fade" id="{{ $id }}" tabindex="-1" aria-labelledby="{{ $id }}Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="needs-validation" novalidate method="post" action="{{ route('user.'.$type) }}">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="financeType" class="form-label">{{ $type }} Type</label>
                        <input type="text" class="form-control" id="financeType" name="{{ $type }}_type" required />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="financeAmount" name="{{ $type }}_amount" min="0" required />
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="{{ $type }}_date" id="{{ $type }}_date" class="form-control" required />
                        <div class="invalid-feedback">
